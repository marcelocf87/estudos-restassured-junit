...
public class ProdutoTest {
    ...
    @Test
    @DisplayName("Validar que o valor do produto final a 0.00 não é permitido")
    public void testValidarLimitesZeradoProibidoValorProduto(){
        // Tenta inserir um produto com valor 0.00 e tentar validar que a mensagem  de erro foi apresentada e ou
